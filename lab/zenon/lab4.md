...
#### Завдання 4.15: Використання елементу "Rectangle" 
...
Використовуючи елемент `Clock` створіть годинник для відображення плинного часу.
...
Створіть функцію для відкриття діалогового вікна керування клапаном 
