...
#### Завдання 5.1: Створення екранутипу CEL
...
Для перемикання на екран 'Хронологія' на панелі  навігації необхідно створити відповідну кнопку. Її можна просто  скопіювати з уже існуючої. Прив’язка функції здійснюється або  перетягуванням її на відповідну кнопку (Drag&Drop), або через пункт  властивостей *Variable / function* -> *Function:*
...
#### Завдання 5.5: Реєстрація спрацювання ліміту
 ...
 Налаштуйте реєстрацію в CEL спрацювання ліміту
...
Налаштуйте роботу CEL в проекті
...
Створіть кнопку виклику екрану AML
...
#### Завдання 5.10: Налаштування спрацювання тривоги
 ...
 Налаштуйте спрацювання тривоги, шляхом означення рівня 'Танк[1].Рівень' розділ Limits та перевірте роботу.
...
Прив'яжіть матриці реакцій до змінної.
...
Зробіть додаткові налаштування тривог.
